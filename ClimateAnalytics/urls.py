...
urlpatterns = patterns('',
    ...
    url(r'^(?P<id>[0-9]+)/(?P<units>[0-9])/(?P<start_date>(19|20)\d\d[- /.](0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01]))/(?P<end_date>(19|20)\d\d[- /.](0[1-9]|1[012])[- /.](0[1-9]|[12][0-9]|3[01]))/citydetail/$', views.CityHistoryGraphs, name='citydetail'),
